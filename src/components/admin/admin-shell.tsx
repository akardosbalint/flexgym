      ...
      <header className="flex items-center justify-between border-b border-ink-border bg-ink px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-sm border border-ink-border px-3.5 py-2 text-sm font-medium text-muted-dark transition-colors hover:border-accent hover:text-accent-on-dark"
          >
            Kilépés
          </button>
        </div>
